...
int cnt[V], ans;
void Add(int i){if(!cnt[a[i]] ++)ans ++;}
void Rem(int i){if(!-- cnt[a[i]])ans --;}
...
void solve_testcase()
{
    ...
    sort(all(qs), [](query a, query b){return a.l / BUCKET == b.l / BUCKET ? a.r < b.r : a.l < b.l;});
