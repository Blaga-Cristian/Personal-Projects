...
void solve_testcase()
{
    ...
    for(int i = 1; i * i <= n - x; ++i)
    {
        if((n - x) % i == 0)
        {
            if(i % 2 == 0 && i >= 2 * x - 2)div_p.insert(i);
            if(i * i != (n - x) && ((n - x) / i) % 2 == 0 && ((n - x) / i) >= 2 * x - 2)div_p.insert(((n - x) / i));
        }
    }
    ...
    for(int i = 1; i * i <= n + x - 2; ++i)
    {
        ...
        {
            if(i % 2 == 0 && i >= 2 * x - 2)div_p.insert(i);
            if(i * i != (n + x - 2) && ((n + x - 2) / i) % 2 == 0 && ((n + x - 2) / i) >= 2 * x - 2)div_p.insert((n + x - 2) / i);
        }
    }
