...
void Back(int p)
{
    ...
    {
        ///CAZUL 1
        ans = min(ans, max(v[0].ff, v[1].ff + v[2].ff) *
                  max(v[0].ss + v[1].ss, v[0].ss + v[2].ss));

        ///CAZUL 2 !!!
        ans = min(ans, max(v[0].ff + v[1].ff, v[0].ff + v[2].ff) *
                  max(v[0].ss, v[1].ss + v[2].ss));


        ///CAZUL 3 !!!
        ans = min(ans, max(v[1].ff + v[2].ff, v[0].ff) *
                  max(v[1].ss + v[0].ss, v[2].ss + v[0].ss));


        ///CAZUL 4 !!!
        ans = min(ans, max(v[0].ff + v[1].ff, v[0].ff + v[2].ff) *
                  max(v[1].ss + v[2].ss, v[0].ss));


        ///CAZUL 5
        ans = min(ans, max(v[0].ff, max(v[1].ff, v[2].ff)) *
                  (v[0].ss + v[1].ss + v[2].ss));

        ///CAZUL 6;
        ans = min(ans, (v[0].ff + v[1].ff + v[2].ff) *
                  max(v[0].ss, max(v[1].ss, v[2].ss)));

//        ///CAZUL 7
//        if(v[2].ff > v[0].ff && v[1].ss > v[0].ss)
//            ans = min(ans, max(v[0].ff + v[1].ff, v[2].ff) *
//                      max(v[1].ss + v[2].ss, v[0].ss + v[2].ss));
