...
void Update1(int l, int r, ll val, int nod = 1, int st = 1, int dr = n) ///modific distanta
{
    if(l <= st && dr <= r)
    {
...
void Update2(int l, int r, ll val, int nod = 1, int st = 1, int dr = n) ///modific inmultirea
{
    if(l <= st && dr <= r)
    {
        tree[nod].v += val;
