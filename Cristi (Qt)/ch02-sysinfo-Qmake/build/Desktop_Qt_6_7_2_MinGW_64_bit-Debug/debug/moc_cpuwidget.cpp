...
struct qt_meta_stringdata_CLASSCpuWidgetENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSCpuWidgetENDCLASS = QtMocHelpers::stringData(
    "CpuWidget",
    "updateSeries",
    ""
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSCpuWidgetENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject CpuWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSCpuWidgetENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSCpuWidgetENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSCpuWidgetENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<CpuWidget, std::true_type>,
        // method 'updateSeries'
...
void *CpuWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSCpuWidgetENDCLASS.stringdata0))
