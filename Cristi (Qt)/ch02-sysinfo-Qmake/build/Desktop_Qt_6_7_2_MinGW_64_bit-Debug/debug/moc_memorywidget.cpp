...
struct qt_meta_stringdata_CLASSMemoryWidgetENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSMemoryWidgetENDCLASS = QtMocHelpers::stringData(
    "MemoryWidget",
    "updateSeries",
    ""
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSMemoryWidgetENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject MemoryWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSMemoryWidgetENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSMemoryWidgetENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSMemoryWidgetENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *MemoryWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSMemoryWidgetENDCLASS.stringdata0))
